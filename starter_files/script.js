...
function checkPeopleStatus(name,age){
    return name + age;
let status= ('adult','minor','senior');
    console.log('Anne'+ 'age'+'adult');
    console.log('Benton'+ 'age'+ 'minor');
    console.log('Chris'+ 'age'+ 'adult');
    console.log('Donna'+ 'age'+ 'minor');
    console.log('Conor'+ 'age' + 'senior');
